                ...
                @foreach($boardingHouses as $house)
                    ...
                    @foreach($house->campuses as $campus)
                        ...
                        <tr class="border-b">
                            ...
                            <td class="border px-2 py-1">{{ ($criteria[3]['kasur'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['lemari'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['meja'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['kursi'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['kipas_angin'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['ac'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['tv'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['wifi'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['kamar_mandi_dalam'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['dapur'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['parkiran'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
                            <td class="border px-2 py-1">{{ ($criteria[3]['termasuk_listrik'] ?? 0) ? 'YA' : 'TIDAK' }}</td>
